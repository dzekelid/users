...
- name: Bitbucket Parameters Users Username Hooks
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/users/master/_listings/bitbucket/users-username-hooks-parameters.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/users/master/_listings/bitbucket/users-username-hooks-parameters-postman.md
x-common:
- type: x-developer
