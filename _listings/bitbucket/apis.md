...
- name: Bitbucket Get Users Username Pipelines Config Variables Variable Uu
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/users/master/_listings/bitbucket/users-username-pipelines-config-variables-variable-uuid-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/users/master/_listings/bitbucket/users-username-pipelines-config-variables-variable-uuid-get-postman.md
x-common:
- type: x-developer
