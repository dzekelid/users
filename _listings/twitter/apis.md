...
- name: Twitter User Search
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/users/master/_listings/twitter/users-search-json-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/users/master/_listings/twitter/users-search-json-get-postman.md
x-common:
- type: x-net-library
