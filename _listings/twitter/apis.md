...
- name: Twitter User Contributees
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/users/master/_listings/twitter/users-contributees-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/users/master/_listings/twitter/users-contributees-get-postman.md
x-common:
- type: x-net-library
