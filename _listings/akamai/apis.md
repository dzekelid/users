...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/users/master/_listings/akamai/user-admin-v1-accounts-accountid-groups-groupid-users-contactid-propertyexceptions-put.md
x-common:
- type: x-base
