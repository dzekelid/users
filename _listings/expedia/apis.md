...
- name: Expedia User Sign-In
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/users/master/_listings/expedia/api-user-sign-in-post.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/users/master/_listings/expedia/api-user-sign-in-post-postman.md
x-common:
- type: x-base
